...
4. **光照应用**
    ...
    void main() {
        ...
        vec4 specularColor = specular(v_lightColor,v_lightPos,v_fragPos,v_viewPos,v_N,32.0,0.5);
    ...
    attribute vec3 a_lightPos;//光源位置
    attribute vec3 a_viewPos;//观察点位置
    ...
    void main() {
    	...
    	//法向量
    	v_N = normalize((nMatrix * vec4(a_position,1.0)).xyz);
    }
    ```
